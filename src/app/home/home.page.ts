...
export class HomePage implements OnInit {
  constructor(readonly progress: ProgressService, readonly storage: StorageService, readonly i18n: TranslationService, private readonly router: Router) {}
  ngOnInit(): void { if (!this.storage.profile()) void this.router.navigateByUrl('/onboarding'); }
  quickPractice(): void { void this.router.navigateByUrl('/practice/interval'); }
