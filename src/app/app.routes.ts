...
export const routes: Routes = [
  ...
  { path: 'practice/:type', loadComponent: () => import('./features/exercise.page').then(m => m.ExercisePage) },
  { path: 'tabs', loadComponent: () => import('./features/tabs.page').then(m => m.TabsPage), children: [
